...
from src.memoryHandling.internal.infrastructure.adapters.process.imp_process_task_producer import ImpProcessTaskProducer

from src.memoryHandling.internal.app.ports.process.i_process_repo import IProcessRepo
from src.memoryHandling.internal.infrastructure.adapters.process.imp_process_repo import ImpProcessRepo

from src.memoryHandling.internal.app.ports.registry.i_registry_task_producer import IRegistryTaskProducer
from src.memoryHandling.internal.infrastructure.adapters.registry.imp_registry_task_producer import ImpRegistryTaskProducer

from src.memoryHandling.internal.app.ports.registry.i_registry_repo import IRegistryRepo
...
from src.memoryHandling.internal.infrastructure.adapters.dll.imp_dll_task_producer import ImpDllTaskProducer

from src.memoryHandling.internal.app.ports.dll.i_dll_repo import IDllRepo
from src.memoryHandling.internal.infrastructure.adapters.dll.imp_dll_repo import ImpDllRepo

from src.memoryHandling.internal.app.ports.activity.i_activity_task_producer import IActivityTaskProducer
from src.memoryHandling.internal.infrastructure.adapters.activity.imp_activity_task_producer import ImpActivityTaskProducer

from src.memoryHandling.internal.app.ports.activity.i_activity_repo import IActivityRepo
from src.memoryHandling.internal.infrastructure.adapters.activity.imp_activity_repo import ImpActivityRepo

from src.memoryHandling.internal.app.ports.privilege.i_privilege_task_producer import IPrivilegeTaskProducer
from src.memoryHandling.internal.infrastructure.adapters.privilege.imp_privilege_task_producer import ImpPrivilegeTaskProducer

from src.memoryHandling.internal.app.ports.privilege.i_privilege_repo import IPrivilegeRepo
from src.memoryHandling.internal.infrastructure.adapters.privilege.imp_privilege_repo import ImpPrivilegeRepo

from src.memoryHandling.internal.app.ports.file.i_file_task_producer import IFileTaskProducer
from src.memoryHandling.internal.infrastructure.adapters.file.imp_file_task_producer import ImpFileTaskProducer

from src.memoryHandling.internal.app.ports.file.i_file_repo import IFileRepo
...
from src.memoryHandling.internal.infrastructure.adapters.service.imp_service_task_producer import ImpServiceTaskProducer
...
from src.memoryHandling.internal.infrastructure.adapters.driver.imp_driver_task_producer import ImpDriverTaskProducer
...
from src.memoryHandling.internal.app.ports.memory.i_memory_task_producer import IMemoryTaskProducer
from src.memoryHandling.internal.infrastructure.adapters.memory.imp_memory_task_producer import ImpMemoryTaskProducer
